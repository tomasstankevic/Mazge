...
# caffeinate (-i idle, -s system) keeps the 24/7 inference host awake for the
# lifetime of the server process.
exec /usr/bin/caffeinate -i -s /Users/tomas/Mazge/.venv-server/bin/uvicorn server.app:app \
  --host 0.0.0.0 \
